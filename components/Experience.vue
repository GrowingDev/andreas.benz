<template>
  <div class="w-full pb-10 flex flex-col justify-center text-center items-center">
    <div class="border-2 p-4 rounded-full border-black max-w-max mb-2">
<svg
    ...
    <h3 style="font-family: FivoSans Light">{{ skill.title }}</h3>
